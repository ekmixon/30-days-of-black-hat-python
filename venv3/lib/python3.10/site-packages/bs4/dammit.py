...
if chardet_module:
    def chardet_dammit(s):
        return None if isinstance(s, str) else chardet_module.detect(s)['encoding']
else:
    def chardet_dammit(s):
        return None
...
class EntitySubstitution(object):
    ...
    def _populate_class_variables():
        ...
        for short in short_entities:
            if long_versions := long_entities_by_first_character[short]:
        ...
        re_definition = f'({"|".join(particles)})'
